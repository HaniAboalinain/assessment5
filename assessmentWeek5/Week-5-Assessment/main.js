...
function calculateTax(salesNum , taxAmount ) {
  // WRITE YOUR CODE UNDER THIS LINE 

tax = salesNum * taxAmount;
amount =  salesNum -tax;

return "You got " +salesNum+ " JD from sales, you should pay "+tax+" JD for tax and you will have "+amount+" JD as net sales.";
...
while(i <= num ){
	...
	i++;
	if (i%2==0){
	return (str+repeatChar(str, num-1)).tolowercase;
	}
	else
		return (str+repeatChar(str, num-1)).toUpperCase;
